          ...
          {showFloatingPanel && (
            <>
              ...
              <motion.div
                ...
                className={`fixed top-0 right-0 h-full w-full ${isMobile ? "" : "max-w-[672px]"
                  } bg-[#676E59] backdrop-blur-md shadow-2xl z-[100000] flex flex-col`}
          ...
          {showModalPanel && (
            <>
              ...
              <motion.div
                ...
                className="bg-[#676E59] backdrop-blur-md shadow-2xl flex flex-col rounded-[20px] border-2 border-[rgba(255,254,247,0.8)]"
              >
                {/* Botón de cerrar */}
                <button
                  onClick={closeModalPanel}
