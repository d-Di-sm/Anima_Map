...
/** Textura del mesh en Mapa.jsx; Residences usa Mapa_N. */
export const mapaTextureSrcAtom = atom("./textures/MP/Mapa.jpg");
...
export const UI = () => {
  ...
  const setMapaTextureSrc = useSetAtom(mapaTextureSrcAtom);
  ...
  const handleButtonClick = (buttonName) => {
    if (activeButton === buttonName) {
      ...
      if (buttonName !== "residences") {
        setMapaTextureSrc("./textures/MP/Mapa.jpg");
      }
      ...
      {isMobile ? (
        <>
          ...
          <motion.button
            ...
            className={`fixed z-30 top-[26px] right-4 w-10 h-10 flex flex-col justify-center items-center gap-1.5 pointer-events-auto ${isMobileMenuOpen ? "" : ""
              }`}
            variants={{
              visible: {
                opacity: 1,
            ...
            {isMobileMenuOpen && (
              ...
              >
                <button
                  ...
                  className="text-sm bg-transparent hover:opacity-70 font-semibold text-[#676E59] transition-opacity duration-500 text-center"
                >
                  HOME
                </button>
                <a
                  href="https://www.animavillage.com/es"
                  target="_blank"
        ...
        >
          <button
            ...
            className="text-[21px] bg-transparent hover:opacity-70 font-semibold text-[#676E59] transition-opacity duration-500 pointer-events-auto"
          >
            HOME
          </button>
          <a
    ...
    md:translate-x-0 md:translate-y-0
      ...
      >
        ...
        <motion.p
          ...
          className={`text-[#676E59] font-bold whitespace-pre-line ${isMobile ? "text-sm" : "text-base"}`}
        >
          {/* We are the best{" "} */}
          {isMobile
        ...
        <div className="flex flex-col gap-[25%] md:flex-row md:gap-6 mt-4 items-center justify-center md:items-start md:justify-start w-full">
          <motion.button
            onClick={() => transitionToHomepage()}
            className={`text-sm bg-transparent hover:bg-[#676E59] font-semibold
           text-[#FFFEF7] hover:text-[#FFFEF7] border-2
            border-[#FFFEF7]  transition-colors duration-500 px-4 py-1 mt-2 rounded-lg uppercase w-2/3 md:w-auto ${isMobile ? "origin-top scale-y-[0.75]" : ""
              }`}
            variants={{
              visible: {
                opacity: 1,
          ...
          <motion.button
            ...
            className={`text-sm bg-transparent hover:bg-[#676E59] font-semibold
           text-[#FFFEF7] hover:text-[#FFFEF7] border-2
            border-[#FFFEF7]  transition-colors duration-500 px-4 py-1 mt-2 rounded-lg uppercase w-2/3 md:w-auto ${activeButton === "masterplan"
      ...
      <motion.section
        ...
        className={`${screen === "pers" ? "pointer-events-auto" : "pointer-events-none"
          }`}
      >
        ...
        >
          <motion.button
            ...
            className={`text-sm font-medium border-2 transition-colors duration-500 px-4 py-1 mt-2 rounded-lg w-1/2 md:w-auto ${activeButton === "residences"
              ? "bg-[#676E59] text-[#FFFEF7] border-[#FFFEF7] hover:text-[#2E3641]"
              : "bg-transparent hover:bg-[#676E59] text-[#FFFEF7] hover:text-[#FFFEF7] border-[#FFFEF7]"
              } ${isMobile ? "origin-top scale-y-[0.75]" : ""}`}
            onClick={() => {
              // handleButtonClick("residences");
              // setSectionCam(2);
              if (activeButton === "residences") {
                setActiveButton(null);
                setMapaTextureSrc("./textures/MP/Mapa.jpg");
              } else {
                setActiveButton("residences");
                setMapaTextureSrc("/textures/MP/Mapa_N.jpg");
              }
            }}
          >
            Night
          ...
          <motion.button
            ...
            className={`bg-transparent hover:bg-[#676E59] text-sm font-medium text-[#FFFEF7] hover:text-[#FFFEF7] border-2 border-[#FFFEF7]  transition-colors duration-500 px-4 py-1 mt-2 rounded-lg w-1/2 md:w-auto ${isMobile ? "origin-top scale-y-[0.25]" : ""
              }`}
          >
            Return
          </motion.button>
        ...
        >
          ...
          {Object.entries(residenceToggles).map(([label, active]) => (
            <button
              ...
              className={`flex items-center justify-between rounded-lg px-3 py-0 text-sm font-semibold border transition-colors ${active
                ? "bg-[#C6C1AE] text-[#2E3641] border-[#FFFEF7] hover:bg-[#676E59] hover:text-[#FFFEF7]"
                : "bg-white/10 text-[#FFFEF7] border-[#FFFEF7]/50 hover:bg-[#676E59] hover:text-[#FFFEF7]"
                }`}
            >
              <span>{label}</span>
              <span
                className={`relative h-4 w-6 rounded-full transition-colors ${active ? "bg-black" : "bg-white/30"
                  }`}
              >
                <span
                  className={`absolute top-0.5 left-0.5 h-3 w-3 rounded-full transition-colors ${active ? "bg-white" : "bg-white"
                    }
