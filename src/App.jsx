...
function App() {
  ...
  const tourMappings = {
    "2BR_G_A": {
      ...
      camRot: [0, 0, 90, 90, 95, 90, 40, 35, 120],
      spaces: [
        "Lobby",
        "Lobby Bedroom",
        "Hall",
    ...
    "2BR_G_B": {
      ...
      camRot: [0, 180, 90, 90, 85, 90, 150, 140, -140],
      spaces: [
        "Lobby",
        "Lobby Bedroom",
        "Hall",
    ...
    "3BR_G_A": {
      ...
      camRot: [-30, 0, 80, 0, 84, 90, 95, 0, 170, 5, 20, 5, 5, 90],
      spaces: [
        "Lobby",
        "Living 1",
        "Living 2",
    ...
    "3BR_G_B": {
      ...
      camRot: [-10, 180, 90, 180, 96, 90, 86, 175, 15, 175, 160, 175, 180, 100],
      // camRot: [-30, 0, 80, 0, 84, 90, 95, 0, 170, 5, 20, 5, 5, 90],
      spaces: [
        "Lobby",
        "Living 1",
    ...
    "4BR_A": {
      ...
      camRot: [-5, 5, 93, 90, 90, 90, 110, 90, 90, 5, 85, 90, 95, 90, 83, 80],
      spaces: [
        "Lobby",
        "Living",
        "Kitchen",
    ...
    "4BR_B": {
      ...
      camRot: [
        -5, 180, 90, -120, 90, 90, 75, 75, 90, 175, 90, 90, 90, 90, 100, 100,
      ],
      spaces: [
        "Lobby",
        "Living",
    ...
    CA_01: {
      ...
      camRot: [0, 80, 0, 100, 115, -55, 90, 95, 90, 90, 48, 110, 90, 90],
      spaces: [
        "Entrance",
        "Terrace 1",
        "Terrace 2",
